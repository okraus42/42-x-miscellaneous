...
for code in range(0, 16):
    ...
    if (r + g + b) < 382:
        print(f"\033[38;5;15m", end="") # white text
    else :
        print(f"\033[38;5;0m", end="") # black text
    print(f"\033[48;5;{code}m{code:3d}: {r:02X} {g:02X} {b:02X}\033[0m")
    ...
    for green in range(0, 6):
        for blue in range(0, 6):
            ...
            if (r + g + b) < 382:
                ...
                print(f"\033[38;5;0m", end="") # black text
            print(f"\033[48;5;{code}m{code:3d}: {r:02X} {g:02X} {b:02X}\033[0m", end="") # no newline
        print()  # blank line after each blue level
...
for gray in range(0, 24):
    ...
    if (level * 3) < 382:
        ...
        print(f"\033[38;5;0m", end="") # black text
    print(f"\033[48;5;{code}m{code:3d}: {level:02X} {level:02X} {level:02X}\033[0m")